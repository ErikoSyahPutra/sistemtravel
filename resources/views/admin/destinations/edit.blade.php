    ...
    <div>
        <form action="{{ route('admin.destinations.update', $destination->id) }}" method="POST"
            ...
            <div>
                ...
                <input type="text" id="slug" name="slug" value="{{ old('slug', $destination->slug) }}"
                    class="w-full border-gray-300 rounded-md">
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="w-full border-gray-300 rounded-md">{{ old('description', $destination->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if ($destination->cover_image)
                    <img src="{{ asset('storage/' . $destination->cover_image) }}"
                        class="w-40 h-40 object-cover rounded-md mb-2 shadow" alt="Cover Image" id="currentImage">
                @endif
            ...
            <div>
                ...
                <textarea name="meta" rows="2" class="w-full border-gray-300 rounded-md">{{ old('meta', $destination->meta) }}</textarea>
            </div>
