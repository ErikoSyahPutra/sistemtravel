    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
            ...
            <div class="flex justify-center">
                <form action="{{ route('customer.destinations') }}" method="GET" class="flex items-center w-full max-w-md">
                    <input 
                        type="text" 
                        name="search" 
            ...
            <div class="mt-10">
                ...
                <div class="space-y-3">
                    @foreach($bookings as $booking)
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border hover:bg-gray-100 transition">
                            <div>
