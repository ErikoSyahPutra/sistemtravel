        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-8 rounded-xl shadow-lg text-center">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 mt-1">Booking Anda <span class="font-semibold text-yellow-600">pending</span>
                ...
                <div class="mt-8">
                    <p class="text-gray-500 text-sm mb-4">
                        Ini adalah halaman simulasi pembayaran. Klik tombol di bawah ini untuk mengonfirmasi (pura-pura)
                        pembayaran.
                    </p>
                    ...
                    <a href="{{ route('customer.booking') }}"
                        class="mt-4 inline-block text-sm text-gray-600 hover:text-blue-500">
