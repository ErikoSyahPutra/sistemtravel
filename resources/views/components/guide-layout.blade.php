    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            {{-- <a href="{{ route('admin.tours.index') }}"
                class="block px-3 py-2 rounded hover:bg-gray-800 {{ request()->routeIs('admin.tours.*') ? 'bg-gray-800' : '' }}">
                Paket Tour
            </a>
            ...
            <a href="{{ route('admin.reports.index') }}"
                class="block px-3 py-2 rounded hover:bg-gray-800 {{ request()->routeIs('admin.reports.*') ? 'bg-gray-800' : '' }}">
                Laporan
            </a> --}}
        </nav>
